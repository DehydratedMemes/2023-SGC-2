%                                           DEFINICIONES:
%
%   En este archivo se deben de poner todas las definiciones de los terminos empleados en el SGA.
%   Apegarse a las convenciones de glossaries-extra.sty
%
...
\newglossaryentry{copia-controlada}{
    name={copia controlada},
    description={Documento que se emite físicamente por el Sistema de Calidad el cual incluye esta leyenda en el mismo, para poder mantener el control de documentos y asegurar que el documento empleado es la versión vigente del documento en cuestión}
}

\newglossaryentry{copia-no-controlada}{
    name={copia no controlada},
    description={Documento (por diferentes razones) del cual se emite una copa física, pero que no es actualizado al sufrir cambios}
}

\newglossaryentry{documento-interno}{
    name={copia no controlada},
    description={%
    Documento que forma parte del sistema de calidad de la compañía, los documentos que incluye el sistema de calidad son los siguientes:\\
        \begin{itemize}
...
\newglossaryentry{listado-maestro}{
    name={listado maestro},
    description={Documento en el que se enumeran los documentos del sistema de calidad; incluye código, título, edición vigente y fecha de revisión}
}

\newglossaryentry{procedimiento-estandar}{
    first={procedimiento estandar (POE)},
    name={procedimiento estandar},
    plural={procedimientos estandar},
    description={Es un término que hace referencia a la acción de proceder, que significa actuar de una forma determinada. El concepto, por otra parte, está vinculado a un método o una manera de ejecutar algo. Consiste en seguir ciertos pasos predefinidos y de manera secuencial para desarrollar una labor de manera eficaz}
}

\newglossaryentry{procedimiento-estandar-de-limpiesza}{
    first={procedimiento estandar de limpieza (POES)},
    name={procedimiento estandar de limpieza},
    plural={procedimientos estandar de limpieza},
    description={Es un término que hace referencia a la acción de proceder, que significa actuar de una forma determinada. El concepto, por otra parte, está vinculado a un método o una manera de ejecutar algo. Consiste en seguir ciertos pasos predefinidos y de manera secuencial para desarrollar una labor de limpieza de manera más eficaz.}
}

\newglossaryentry{instruccion-de-trabajo}{
    name={instrucción de trabajo},
    description={Desarrollan secuencialmente los pasos a seguir para la correcta realización de un trabajo específico y que normalmente involucra a una sola persona o área de responsabilidad.}
}

\newglossaryentry{especificacion}{
    name={especificación},
    plural={especificaciones},
    description={Documento que describe en forma detallada las características o requisitos técnicos de un servicio o producto y que deben cumplirse para lograr un propósito determinado. Pueden ser documentos internos y/o externos.}
}

\newglossaryentry{anexo}{
    name={anexo},
    plural={anexos},
    description={documentos que complementan lo descrito en un procedimiento. Estos pueden ser referencias bibliográficas, normas, formatos, esquemas, gráficos etc.}
}

\newglossaryentry{formato}{
    name={formato},
    plural={formato},
    description={documento en el que se plasman los resultados obtenidos y actividades realizadas y que representara evidencia de cumplimiento de la o las actividades.}
}

\newglossaryentry{registro}{
    name={registro},
    plural={registros},
    description={es un formato que ha sido completado y que se resguarda como evidencia de la realización de actividades específicas}
}
...
%     name={alta dirección},
%     description={persona o grupo de personas que dirige y controla una organización al más alto nivel\footnote{La alta dirección tiene el poder para delegar autoridad y proporcionar recursos dentro de la organización.}\footnote{Si el alcance del sistema de gestión comprende sólo una parte de una organización entonces la alta dirección se refiere a quienes dirigen y controlan esa parte de la organización.}}
% }
