...
\end{enumerate}
\todo{hacerlo especificación}
\begin{scheme}
	\centering
	\missingfigure{Diagrama sobre inspección de alimentos}
	\caption[Inspección rutinaria de alimentos almacenados]{Inspección rutinaria de alimentos almacenados}
\end{scheme}
...
\subsection{Acciones preventivas}\todo{actualizar}
% \AcPGen
