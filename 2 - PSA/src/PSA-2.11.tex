...
\section{\Titulo}
\label{sec:AccEnCasoDeEmergencia}
...
\index{Acciones inmediatas!en caso de incendio en la periferia}
\begin{enumerate}
...
\index{Acciones inmediatas!en caso de corte eléctrico}
\begin{itemize}
...
\index{Acciones inmediatas!en caso de avería de equipos de enfriamiento}
