...
\SetCurrentTrackedDialect{mexicanspanish}
...
\pagestyle{formato}
\include{src/ToC.tex} 
\include{src/G-1.tex} %TODO Acomodar correctamente
...
\include{src/BPM-A.3.tex}
\include{src/BPM-Gloss.tex}
\include{src/BPM-Ind.tex}
\end{document}