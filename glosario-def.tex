...
\newglossaryentry{cadena-alimentaria}{
    ...
    description={%
    secuencia de etapas en la producción, procesamiento, distribución, almacenamiento, y manipulación de un \glsname{alimento} y sus ingredientes, desde la producción primaria hasta el consumo.
    \begin{itemize}
...
\newglossaryentry{peligro-relacionado-con-la-inocuidad-de-los-alimentos}
{
    ...
    description={%
    agente biológico, químico o físico en el \glsname{alimento} con potencial de causar un efecto adverso en la salud
        \begin{itemize}
...
{alimento-RTE}{RTE}{\textit{ready-to-eat}}
...
\newabbreviation{CFE}{CFE}{Comisión Federal de Electricidad}

\newabbreviation[%
    description={parte de un sistema de gestión relacionada con los inventarios del almacén}
]{SGA}{SGA}{Sistema de Gestión del Almacén}
...
\newabbreviation{PEPS}{PEPS}{Primeras Entradas, Primeras Salidas}

\newabbreviation[%
    description = {parte de un sistema de gestión relacionada con la calidad},
]{SGC}{SGC}{Sistema de Gestión de Calidad}

\newabbreviation{SENASICA}{SENASICA}{Servicio Nacional de Sanidad, Inocuidad y Calidad Agroalimentaria}
...
]{MSDS}{MSDS}{Hoja de Seguridad de Material}
...
\newabbreviation{PSA}{PSA}{Programa de Seguridad Alimentaria}
...
\newacronym{LPA}{LPA}{Lista de Proveedores Autorizados}
\newacronym{SADER}{SADER}{Secretaría de Agricultura y Desarrollo Rural}
\newacronym{BPH}{BPH}{Buenas Prácticas de Higiene}
\newacronym{RDF}{RDF}{Red de Fríos S.A. de C.V.}
\newacronym{BPD}{BPD}{Buenas Prácticas de Distribución}

\newacronym[%
    description={\glsname{medida-de-control} o combinación de medidas de control aplicadas para prevenir o reducir un peligro significativo relacionado con la inocuidad de los \glsname{alimento} a un nivel-aceptable, y donde el \glsname{criterio-de-acción} y medición u observación permite el control efectivo del \glsname{proceso} y/o \glsname{producto}}]{PPRO}{PPRO}{Programa de Prerrequisitos Operativos}
...
]{PPR}{PPR}{programa de prerrequisito}

\newacronym{HACCP}{HACCP}{Analisis de Peligros y Puntos Criticos de Control (APPC), del inglés \textit{Hazard Analysis and Critical Control Points (HACCP)}}

\newglossaryentry{informacion-documentada}{
    name={información documentada},
    description={%
    \glsname{informacion} que una \glsname{organizacion} tiene que controlar y mantener, y el medio que la contiene
    \begin{itemize}
...
\newglossaryentry{registro}{
    ...
    plural={registros},
    description={%
    \glsname{documento} que presenta resultados obtenidos o proporciona evidencia de actividades realizadas
    \begin{itemize}
...
\newglossaryentry{documento}{
    ...
    plural={documentos},
    description={%
    \glsname{informacion} y el medio en el que está contenida
    \begin{itemize}
...
\newglossaryentry{especificacion}{
    ...
    description={%
    \glsname{documento} que establece requisitos
    \begin{itemize}
...
\newglossaryentry{manual-de-calidad}{
    ...
    description={%
    \glsname{especificacion} para el sistema de gestión de la calidad de una organización
    \begin{itemize}
